...
/// <summary>
/// Static world prop for tree entities. Each tree type defines its own
...
/// </summary>
public sealed class Tree : IWorldProp
{
    ...
    /// <summary>
    /// Creates a tree at a world position with one or more collision boxes
    /// defined relative to the sprite's top-left corner.
    /// </summary>
    /// <param name="position">Top-left world position in pixels.</param>
    /// <param name="texture">Tree texture used for drawing and visual bounds.</param>
